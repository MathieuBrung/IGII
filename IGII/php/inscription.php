<?php
	...
	if (isset($_POST['nomIns']) && isset($_POST['mdtIns']) && isset($_POST['email'])) {
...
#4			#Fonction #1Inscription : Vérifier que le mail n'est pas déjà utilisé
			...
			{	
				...
				create_user($login, $password, $email, $connexion);	
			}
			else
			{
